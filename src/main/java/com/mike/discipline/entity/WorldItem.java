 ...
 *
 * 「从月壤到盖亚」——目录按地球演化史组织成七个纪元（epoch 0..6）：
 *   0 冥古宙（荒芜月面，始终解锁）→ 1 大气纪 → 2 海洋纪 → 3 生命纪
 *   → 4 绿色纪 → 5 动物纪 → 6 文明纪
 *
...
public enum WorldItem {
    ...
    /* ---- 0 · 冥古宙：荒芜月面 ---- */
    CRATER("静海环形山", "冥古宙", 20, "在月壤上砸出一圈崭新的撞击坑", 0, false, 3),
    ROCKS("月岩群", "冥古宙", 30, "几组嶙峋的月面巨岩", 0, false, 3),
    ROVER("月面探测车", "冥古宙", 60, "孤独巡视荒原的六轮探测车", 0, false, 3),
    CRYSTAL("能量水晶", "冥古宙", 150, "深埋月壤的晶簇，夜间仍然闪耀", 0, false, 3),
